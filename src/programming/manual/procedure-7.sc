...
def square(a: ZS): Unit = {
  Contract(
    ...
    Ensures(
      a.size == In(a).size,
      ∀(0 until a.size)(i => a(i) == In(a)(i) * In(a)(i)) // ∀{ (i: Z) => (0 <= i & i < a.size) -->: (a(i) == In(a)(i) * In(a)(i)) }
    )
  )
  ...
  Deduce(
    //@formatter:off
     ...
     6 #> Let { (j: Z) => SubProof(
      ...
      13 #> ((0 <= j & j < x) -->: (a(j) == In(a)(j) * In(a)(j)))              by SImplyI(7)
    )},
    ...
    15 #> Let { (j: Z) => SubProof(
      ...
      21 #> ((x <= j & j < a.size) -->: (a(j) == In(a)(j)))                    by SImplyI(16)
    )},
  ...
  while (x != a.size) {
    ...
    Deduce(
      ...
      10 #> ((x <= x & x < Old(a).size) -->: (Old(a)(x) == In(a)(x)))          by AllE[Z](3),
      11 #> (x <= x)                                                           by Algebra T,
      ...
      15 #> Let { (j: Z) => SubProof(
        16 #> SubProof(
          ...
          20 #> SubProof(
            ...
            23 #> ((0 <= j & j < x) -->: (Old(a)(j) == In(a)(j) * In(a)(j)))   by AllE[Z](2),
        ...
        31 #> ((0 <= j & j <= x) -->: (a(j) == In(a)(j) * In(a)(j)))           by SImplyI(16)
      )},
      ...
      //@formatter:off
       ...
       9 #> Let { (j: Z) => SubProof(
        10 #> SubProof(
          ...
          16 #> ((0 <= j & j <= Old(x)) -->: (a(j) == In(a)(j) * In(a)(j)))    by AllE[Z](4),
          17 #> (a(j) == In(a)(j) * In(a)(j))                                  by SImplyE(16, 15)
        ),
        18 #> ((0 <= j & j < x) -->: (a(j) == In(a)(j) * In(a)(j)))            by SImplyI(10)
      )},
